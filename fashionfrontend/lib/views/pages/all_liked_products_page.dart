    ...
    return SliverAppBar(
      ...
      actions: [
        Container(
          ...
          child: IconButton(
            icon: Icon(Icons.refresh_rounded, color: scheme.onSurface, size: 20),
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Container(
            ...
            child: Icon(
              ...
              color: _isSearchFocused ? scheme.primary : Colors.grey.withValues(alpha: 0.6),
              size: 20,
            ),
          ),
          ...
          Expanded(
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                onChanged: onChanged,
                icon: Icon(Icons.keyboard_arrow_down_rounded, color: scheme.secondary, size: 16),
